...
namespace ICE {
std::shared_ptr<Mesh> OBJLoader::loadFromOBJ(const std::string &path) {
    ...
    for (size_t f = 0; f < shapes[s].mesh.num_face_vertices.size(); f++) {
        ...
        Eigen::Vector3f trianglesVertices[3] = {Eigen::Vector3f(), Eigen::Vector3f(), Eigen::Vector3f()};
    ...
    /*
        ...
        */
    return std::make_shared<Mesh>(vertices, normals, uvs, indices);
}
}  // namespace ICE