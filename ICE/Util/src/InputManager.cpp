...
bool InputManager::isKeyDown(ICE::Key key) { return getKeyState(key) == KeyState::DOWN; }
...
float InputManager::getMouseX() { return m_x; }

float InputManager::getMouseY() { return m_y; }

Eigen::Vector2f InputManager::getMouseDelta() { return {m_x - m_prev_x, m_y - m_prev_y}; }
}  // namespace ICE